...
export const Header = () => (
    <header className="sans-serif">
        <div className="cover bg-left bg-center-l" 
            style={ {backgroundImage : `url(https://mrmrs.github.io/photos/u/011.jpg)`}} >
            ...
            <nav className="dt w-100 mw8 center"> 
                ...
                <a href="/" className="dib w2 h2 pa1 ba b--white-90 grow-large border-box">
                    <svg 
                        ...
                        data-icon="skull" viewBox="0 0 32 32"><title>skull icon</title><path d="M16 0 C6 0 2 4 2 14 L2 22 L6 24 L6 30 L26 30 L26 24 L30 22 L30 14 C30 4 26 0 16 0 M9 12 A4.5 4.5 0 0 1 9 21 A4.5 4.5 0 0 1 9 12 M23 12 A4.5 4.5 0 0 1 23 21 A4.5 4.5 0 0 1 23 12"></path></svg>
                </a>
                </div>
