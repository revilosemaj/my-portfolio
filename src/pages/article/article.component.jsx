...
export const Article = () => (
    <section className="article mw7 center avenir">
      ...
      <article className="bb b--black-10">
        <a className="db pv4 ph3 ph0-l no-underline black dim" href="#0">
          <div className="flex flex-column flex-row-ns">
            <div className="pr3-ns mb4 mb0-ns w-100 w-40-ns">
              <img src="http://mrmrs.github.io/photos/warehouse.jpg" className="db" alt="A warehouse with stacked shelves." />
            </div>
            <div className="w-100 w-60-ns pl3-ns">
      ...
      <article className="bb b--black-10">
        <a className="db pv4 ph3 ph0-l no-underline black dim" href="#0">
          <div className="flex flex-column flex-row-ns">
            <div className="pr3-ns mb4 mb0-ns w-100 w-40-ns">
              <img src="http://mrmrs.github.io/photos/whale.jpg" className="db" alt="A whale's tale coming crashing out of the water." />
            </div>
            <div className="w-100 w-60-ns pl3-ns">
